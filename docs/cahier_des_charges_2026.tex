...
\begin{titlepage}
    \centering
    \vspace*{3cm}
    {\Huge\bfseries Projet interdisciplinaire - Contrôle qualité intelligent\par}
    \vspace{0.8cm}
    {\LARGE Mesure de marche\par}
    \vspace{1.5cm}
    {\Large Robin Laborde, Thoma Chalon\par}
    \vspace{2cm}
    {\large Yuri Lopez de Meneses, Alvaro Hüssy\\
    HES-SO Master, Printemps 2026\par}
    \vfill
\end{titlepage}
